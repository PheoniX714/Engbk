{* Title *}
{$meta_title = "Список категорий товаров" scope=parent}
{$sm_groupe = 'catalog' scope=parent}
{$sm_item = "product-categories" scope=parent}
{$page_additional_css = '
        ...
        <div class="col-md-12">
          <div class="box box-success">
            <div class="box-header">
			  ...
			  <a href="{url module=CategoryAdmin id=null}" class="btn btn-sm btn-primary btn-flat pull-right"><i class="fa fa-plus"></i> <b> Добавить категорию</b></a>
			</div>
            <!-- /.box-header -->
            <div class="box-body no-padding">
				...
				<ul class="sortable-list sortable">
					...
					<li>
					  ...
					  <!-- todo text -->
					  <span class="text"><a href="{url module=CategoryAdmin id=$category->id return=$smarty.server.REQUEST_URI}">{$category->name|escape}</a></span>
