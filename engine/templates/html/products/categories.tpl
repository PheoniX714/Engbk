{* Title *}
{$meta_title = "Категории товаров" scope='root'}
...
<div id="contacts" class="page-layout simple left-sidebar-floating tabbed">
	...
	<div class="page-header bg-secondary text-auto row no-gutters align-items-center justify-content-between p-4 p-sm-6">
		...
		<div class="col-auto">
			<a href="{url module=CategoryAdmin id=null}" class="btn btn-light fuse-ripple-ready"><i class="icon-file-plus mr-0 mr-md-2"></i><span class="m-none"> Добавить категорию</span></a>
		</div>
	</div>
							...
							<div class="todo-item pl-{$level*7} pr-2 py-4 row no-gutters flex-wrap flex-sm-nowrap align-items-center">
								...
								<div class="info col px-4 d-flex align-items-start align-sm-items-center justify-content-left flex-column flex-sm-row">
									...
									<div class="title mr-4">
										<a class="td-wh-none {if !$category->name}text-red{/if}" href="{url module=CategoryAdmin id=$category->id language_id=$filter_language return=null}">{if !$category->name}Отсутствует перевод{else}{$category->name|escape}{/if}</a>
									</div>
								...
								<div class="buttons col-12 col-sm-auto d-flex align-items-center justify-content-end">
									...
									<a href="{url module=CategoryAdmin id=$category->id language_id=$filter_language return=null}" class="btn btn-icon" data-toggle="tooltip" data-placement="bottom" title="Редактировать">
									...
									<a href="../catalog/{$category->url}" class="btn btn-icon" target="__blank" data-toggle="tooltip" data-placement="bottom" title="Открыть в новом окне">
