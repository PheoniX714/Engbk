<?php /* Smarty version Smarty-3.1.18, created on 2017-11-19 13:42:49
         compiled from "/home/astyle/mdk.ua/www/templates/default/html/pagination.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14100882435a06a436d84e50-78971155%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '505e8b908181cb17274fcde9b831685b9e2d335c' => 
    array (
      0 => '/home/astyle/mdk.ua/www/templates/default/html/pagination.tpl',
      1 => 1511091768,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14100882435a06a436d84e50-78971155',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_5a06a436e07421_59740945',
  'variables' => 
  array (
    'products' => 0,
    'total_pages_num' => 0,
...
<?php if ($_valid && !is_callable('content_5a06a436e07421_59740945')) {function content_5a06a436e07421_59740945($_smarty_tpl) {?><?php if (count($_smarty_tpl->tpl_vars['products']->value)>2||$_smarty_tpl->tpl_vars['total_pages_num']->value>1) {?>
	<div class="pagination">
	<?php if ($_smarty_tpl->tpl_vars['total_pages_num']->value>1) {?>
		<?php $_smarty_tpl->tpl_vars['visible_pages'] = new Smarty_variable(7, null, 0);?>
		<?php $_smarty_tpl->tpl_vars['page_from'] = new Smarty_variable(1, null, 0);?>
		<?php if ($_smarty_tpl->tpl_vars['current_page_num']->value>floor($_smarty_tpl->tpl_vars['visible_pages']->value/2)) {?><?php $_smarty_tpl->tpl_vars['page_from'] = new Smarty_variable(max(1,$_smarty_tpl->tpl_vars['current_page_num']->value-floor($_smarty_tpl->tpl_vars['visible_pages']->value/2)-1), null, 0);?><?php }?>
		<?php if ($_smarty_tpl->tpl_vars['current_page_num']->value>$_smarty_tpl->tpl_vars['total_pages_num']->value-ceil($_smarty_tpl->tpl_vars['visible_pages']->value/2)) {?><?php $_smarty_tpl->tpl_vars['page_from'] = new Smarty_variable(max(1,$_smarty_tpl->tpl_vars['total_pages_num']->value-$_smarty_tpl->tpl_vars['visible_pages']->value-1), null, 0);?><?php }?>
		...
		<a <?php if ($_smarty_tpl->tpl_vars['current_page_num']->value==1) {?>class="selected"<?php }?> href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('page'=>null),$_smarty_tpl);?>
"><?php if ($_smarty_tpl->tpl_vars['current_page_num']->value==1) {?>1<?php } elseif ($_smarty_tpl->tpl_vars['total_pages_num']->value<$_smarty_tpl->tpl_vars['visible_pages']->value) {?>1<?php } else { ?>&lt;&lt;<?php }?></a>
		<?php if ($_smarty_tpl->tpl_vars['visible_pages']->value<$_smarty_tpl->tpl_vars['total_pages_num']->value-1&&$_smarty_tpl->tpl_vars['current_page_num']->value>($_smarty_tpl->tpl_vars['visible_pages']->value-1)/2+2) {?><a class="prev_page_link" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('page'=>$_smarty_tpl->tpl_vars['current_page_num']->value-floor($_smarty_tpl->tpl_vars['visible_pages']->value/2)),$_smarty_tpl);?>
">&lt;</a><?php }?>			
...
?>
			...
			<?php } else { ?><a <?php if ($_smarty_tpl->tpl_vars['p']->value==$_smarty_tpl->tpl_vars['current_page_num']->value) {?>class="selected"<?php }?> href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('page'=>$_smarty_tpl->tpl_vars['p']->value),$_smarty_tpl);?>
"><?php echo $_smarty_tpl->tpl_vars['p']->value;?>
</a><?php }?>
			<?php endfor; endif; ?>
		<?php if ($_smarty_tpl->tpl_vars['visible_pages']->value<$_smarty_tpl->tpl_vars['total_pages_num']->value-1&&$_smarty_tpl->tpl_vars['total_pages_num']->value-$_smarty_tpl->tpl_vars['current_page_num']->value>$_smarty_tpl->tpl_vars['visible_pages']->value/2+1) {?><a class="next_page_link" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('page'=>$_smarty_tpl->tpl_vars['current_page_num']->value+floor($_smarty_tpl->tpl_vars['visible_pages']->value/2)),$_smarty_tpl);?>
">	&gt;</a><?php }?>			
		<a <?php if ($_smarty_tpl->tpl_vars['current_page_num']->value==$_smarty_tpl->tpl_vars['total_pages_num']->value) {?>class="selected"<?php }?>  href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('page'=>$_smarty_tpl->tpl_vars['total_pages_num']->value),$_smarty_tpl);?>
...
<?php } elseif ($_smarty_tpl->tpl_vars['total_pages_num']->value<$_smarty_tpl->tpl_vars['visible_pages']->value) {?><?php echo $_smarty_tpl->tpl_vars['total_pages_num']->value;?>
<?php } else { ?>&gt;&gt;<?php }?></a>
	<?php }?>
	</div>
<?php }?><?php }} ?>
