...
class OrderView extends View
{
	...
	{
		parent::__construct();
		$this->templates->smarty->registerPlugin("function", "checkout_form", array($this, 'checkout_form'));
	}
	...
	function fetch_order()
	{
		...
		$purchase->size_name = $sizes[$purchase->size_id];
		$purchase->color_name = $colors[$purchase->color_id];
		...
		// Выводим заказ
		return $this->body = $this->templates->fetch('order.tpl');
	}
